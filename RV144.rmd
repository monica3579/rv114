...
In the data there are a total of 16402 people that they did the trial on. 
...
In this trial, they used a bar graph for the graphical results, a precent chart for the numerical results, and a chi square chart for the inferential results. 
...
the plot below is a bar graph based on the 16402 people that were involved in this test. the first side showes the expected outcome of the people that recieved the vacine and the placebo. the other side showes the true results. 40% of the people that got the vacine still were infected with hiv. 55% that recieved the placebo, got infected with hiv.  
...
This chart showes that the vacine is effective. 40% out of the 1640 people still got the hiv virus. it can be showed that 60% of the people were still uninfected. as for the placebo, 60% of the people still in fact got the hiv visur. 
